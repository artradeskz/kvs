...
# === ИНСТРУКЦИИ, ВСЕГДА ТРЕБУЮЩИЕ ЗАГЛУШКУ НА ПЕРВОМ ПРОХОДЕ ===
# Эти инструкции содержат целевые метки в операндах, которые могут быть
# определены позже (в том числе в других секциях)
