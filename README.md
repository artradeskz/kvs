...
- **Поддержка секций** — разделение на `.текст` (код), `.данные` (данные) и `.бсс` (неинициализированные данные)
...
.бсс            ; секция неинициализированных данных (опциональна)
...
| `.бсс` | Начало секции неинициализированных данных | `.бсс` |
...
- ❌ Старшие 8-битные регистры (AH, BH, CH, DH) и расширенные младшие (SPL, BPL, SIL, DIL)
- ❌ Регистры R8–R15 и их байтовые/словные версии
...
- Секция `.бсс` для неинициализированных данных
