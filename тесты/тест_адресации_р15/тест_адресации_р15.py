...
"""
Тест для проверки косвенной адресации через регистр R15
...
SOURCE_REL = SCRIPT_DIR / "тест_адресации_р15.квс"

def clean():
    """Очищает артефакты сборки"""
    files = [
        "тест_адресации_р15.elf",
        "тест_адресации_р15.csv", 
        "тест_адресации_р15.аст",
        "тест_адресации_р15.токены",
        "тест_адресации_р15.константа",
        "тест_адресации_р15_pass4.log"
    ]
    for f in files:
        f_path = SCRIPT_DIR / f
        if f_path.exists():
...
def test_with_char(char: str, expected_code: int) -> bool:
    ...
    elf_path = SCRIPT_DIR / "тест_адресации_р15.elf"
...
def main():
    ...
    print("DEBUG: Начало теста тест_адресации_р15", file=sys.stderr)
