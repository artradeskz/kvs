...
"""
Тест для проверки косвенной адресации через регистр R13
...
SOURCE_REL = SCRIPT_DIR / "тест_адресации_р13.квс"

def clean():
    """Очищает артефакты сборки"""
    files = [
        "тест_адресации_р13.elf",
        "тест_адресации_р13.csv", 
        "тест_адресации_р13.аст",
        "тест_адресации_р13.токены",
        "тест_адресации_р13.константа",
        "тест_адресации_р13_pass4.log"
    ]
    for f in files:
        f_path = SCRIPT_DIR / f
        if f_path.exists():
...
def test_with_char(char: str, expected_code: int) -> bool:
    ...
    elf_path = SCRIPT_DIR / "тест_адресации_р13.elf"
