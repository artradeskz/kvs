...
"""
Тест для проверки косвенной адресации через регистр R11
...
SOURCE_REL = SCRIPT_DIR / "тест_адресации_р11.квс"

def clean():
    """Очищает артефакты сборки"""
    files = [
        "тест_адресации_р11.elf",
        "тест_адресации_р11.csv", 
        "тест_адресации_р11.аст",
        "тест_адресации_р11.токены",
        "тест_адресации_р11.константа",
        "тест_адресации_р11_pass4.log"
    ]
    for f in files:
        f_path = SCRIPT_DIR / f
        if f_path.exists():
...
def test_with_char(char: str, expected_code: int) -> bool:
    ...
    elf_path = SCRIPT_DIR / "тест_адресации_р11.elf"
...
def main():
    ...
    print("DEBUG: Начало теста тест_адресации_р11", file=sys.stderr)
