...
"""
Тест для проверки косвенной адресации через регистр R14
...
SOURCE_REL = SCRIPT_DIR / "тест_адресации_р14.квс"

def clean():
    """Очищает артефакты сборки"""
    files = [
        "тест_адресации_р14.elf",
        "тест_адресации_р14.csv", 
        "тест_адресации_р14.аст",
        "тест_адресации_р14.токены",
        "тест_адресации_р14.константа",
        "тест_адресации_р14_pass4.log"
    ]
    for f in files:
        f_path = SCRIPT_DIR / f
        if f_path.exists():
...
def test_with_char(char: str, expected_code: int) -> bool:
    ...
    elf_path = SCRIPT_DIR / "тест_адресации_р14.elf"
...
def main():
    ...
    print("DEBUG: Начало теста тест_адресации_р14", file=sys.stderr)
