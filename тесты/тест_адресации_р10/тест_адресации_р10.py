...
"""
Тест для проверки косвенной адресации через регистр R10
...
SOURCE_REL = SCRIPT_DIR / "тест_адресации_р10.квс"

def clean():
    """Очищает артефакты сборки"""
    files = [
        "тест_адресации_р10.elf",
        "тест_адресации_р10.csv", 
        "тест_адресации_р10.аст",
        "тест_адресации_р10.токены",
        "тест_адресации_р10.константа",
        "тест_адресации_р10_pass4.log"
    ]
    for f in files:
        f_path = SCRIPT_DIR / f
        if f_path.exists():
...
def test_with_char(char: str, expected_code: int) -> bool:
    ...
    elf_path = SCRIPT_DIR / "тест_адресации_р10.elf"
...
def main():
    ...
    print("DEBUG: Начало теста тест_адресации_р10", file=sys.stderr)
